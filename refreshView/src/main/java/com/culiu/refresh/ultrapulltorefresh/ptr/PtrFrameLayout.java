package com.culiu.refresh.ultrapulltorefresh.ptr;
...
import com.culiu.refresh.R;
import com.culiu.refresh.ultrapulltorefresh.ptr.indicator.PtrIndicator;
import com.culiu.refresh.ultrapulltorefresh.ptr.util.PtrCLog;
...
public class PtrFrameLayout extends ViewGroup {
    ...
    public boolean dispatchTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                /**
                 * check slide horizontal or vertical.if the radian less than
                 * {@link HORIZONTAL_SENSITIVITY_RADIAN}, we think its horizontal slide.
                 */
                if (mPtrIndicator.checkHorizontalOrVertical())
                    return dispatchTouchEventSupper(e);
                ...
                if ((moveUp && canMoveUp) || moveDown) {
                    if (checkCanContinueMove(this, mPtrIndicator)) {
                        movePos(offsetY);
                    }
                    return true;
                }
    ...
    /**
     * check header and content view can continue move, default value is true.
     * control header and content view move distance.
     *
     * @param ptrFrameLayout
     * @param ptrIndicator
     * @return
     */
    protected boolean checkCanContinueMove(PtrFrameLayout ptrFrameLayout,
    ...
    final public void refreshComplete() {
        ...
        /**
         * 时间戳是long型数据，强转为int会导致溢出，出现逻辑不正确的情况
         */
    ...
    /**
     * return finger horizontal sensitivity slide radian.
     *
     * @return
     */
    public double getHorizontalSensitivityRadian() {
        return mPtrIndicator.getHorizontalSensitivityRadian();
    }

    /**
     * set finger horizontal sensitivity angel. please set angel, it's auto calc to radian.
     *
     * @param horizontalSensitivityAngel
     */
    public void setHorizontalSensitivityAngel(double horizontalSensitivityAngel) {
        mPtrIndicator.setHorizontalSensitivityRadian(horizontalSensitivityAngel);
    }
